...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    %0:2 = call @inputs() : () -> (tensor<10xui16>, tensor<i32>)
    %1 = call @expected() : () -> tensor<ui16>
    %2 = call @_take(%0#0, %0#1) : (tensor<10xui16>, tensor<i32>) -> tensor<ui16>
    %3 = stablehlo.custom_call @check.eq(%2, %1) : (tensor<ui16>, tensor<ui16>) -> tensor<i1>
    return %3 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<10xui16>, tensor<i32>) {
    %0 = stablehlo.constant dense<[4, 0, 0, 2, 1, 4, 0, 2, 3, 4]> : tensor<10xui16>
    %1 = stablehlo.constant dense<2> : tensor<i32>
    return %0, %1 : tensor<10xui16>, tensor<i32>
  }
  func.func private @expected() -> tensor<ui16> {
    %0 = stablehlo.constant dense<0> : tensor<ui16>
    return %0 : tensor<ui16>
  }
  func.func private @_take(%arg0: tensor<10xui16>, %arg1: tensor<i32>) -> tensor<ui16> {
