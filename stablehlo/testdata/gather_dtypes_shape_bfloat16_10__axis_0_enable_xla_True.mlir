...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    %0:2 = call @inputs() : () -> (tensor<10xbf16>, tensor<i32>)
    %1 = call @expected() : () -> tensor<bf16>
    %2 = call @_take(%0#0, %0#1) : (tensor<10xbf16>, tensor<i32>) -> tensor<bf16>
    %3 = stablehlo.custom_call @check.eq(%2, %1) : (tensor<bf16>, tensor<bf16>) -> tensor<i1>
    return %3 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<10xbf16>, tensor<i32>) {
    %0 = stablehlo.constant dense<[-6.875000e-01, 6.787110e-02, 4.000000e+00, 6.757810e-01, 3.671880e+00, -2.218750e+00, -2.984380e+00, 8.984370e-01, 8.007810e-01, -1.984380e+00]> : tensor<10xbf16>
    %1 = stablehlo.constant dense<2> : tensor<i32>
    return %0, %1 : tensor<10xbf16>, tensor<i32>
  }
  func.func private @expected() -> tensor<bf16> {
    %0 = stablehlo.constant dense<4.000000e+00> : tensor<bf16>
    return %0 : tensor<bf16>
  }
  func.func private @_take(%arg0: tensor<10xbf16>, %arg1: tensor<i32>) -> tensor<bf16> {
