...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    %0:2 = call @inputs() : () -> (tensor<10xf16>, tensor<i32>)
    %1 = call @expected() : () -> tensor<f16>
    %2 = call @_take(%0#0, %0#1) : (tensor<10xf16>, tensor<i32>) -> tensor<f16>
    %3 = stablehlo.custom_call @check.eq(%2, %1) : (tensor<f16>, tensor<f16>) -> tensor<i1>
    return %3 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<10xf16>, tensor<i32>) {
    %0 = stablehlo.constant dense<[3.021480e+00, -1.335940e+00, 9.321280e-01, -6.640630e+00, 4.833980e-02, 4.667970e-01, -3.580080e+00, -1.394530e+00, -3.746090e+00, 4.324220e+00]> : tensor<10xf16>
    %1 = stablehlo.constant dense<2> : tensor<i32>
    return %0, %1 : tensor<10xf16>, tensor<i32>
  }
  func.func private @expected() -> tensor<f16> {
    %0 = stablehlo.constant dense<9.321280e-01> : tensor<f16>
    return %0 : tensor<f16>
  }
  func.func private @_take(%arg0: tensor<10xf16>, %arg1: tensor<i32>) -> tensor<f16> {
