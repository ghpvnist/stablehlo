...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %58 = stablehlo.broadcast_in_dim %48, dims = [] : (tensor<ui32>) -> tensor<4xui32>
    %59 = stablehlo.add %51, %58 : tensor<4xui32>
    %60 = stablehlo.broadcast_in_dim %50, dims = [] : (tensor<ui32>) -> tensor<4xui32>
    %61 = stablehlo.add %52, %60 : tensor<4xui32>
    %62 = stablehlo.constant dense<0> : tensor<i32>
    %63 = stablehlo.constant dense<0> : tensor<i32>
    %64:9 = stablehlo.while(%iterArg = %63, %iterArg_0 = %62, %iterArg_1 = %59, %iterArg_2 = %61, %iterArg_3 = %50, %iterArg_4 = %57, %iterArg_5 = %48, %iterArg_6 = %53, %iterArg_7 = %54) : tensor<i32>, tensor<i32>, tensor<4xui32>, tensor<4xui32>, tensor<ui32>, tensor<ui32>, tensor<ui32>, tensor<4xui32>, tensor<4xui32>
     cond {
      %145 = stablehlo.constant dense<5> : tensor<i32>
      %146 = stablehlo.compare  LT, %iterArg, %145,  SIGNED : (tensor<i32>, tensor<i32>) -> tensor<i1>
      stablehlo.return %146 : tensor<i1>
      ...
      %151 = stablehlo.shift_left %iterArg_2, %150 : tensor<4xui32>
      %152 = stablehlo.constant dense<32> : tensor<ui32>
      %153 = stablehlo.subtract %152, %148 : tensor<ui32>
      %154 = stablehlo.broadcast_in_dim %153, dims = [] : (tensor<ui32>) -> tensor<4xui32>
      ...
      %162 = stablehlo.shift_left %157, %161 : tensor<4xui32>
      %163 = stablehlo.constant dense<32> : tensor<ui32>
      %164 = stablehlo.subtract %163, %159 : tensor<ui32>
      %165 = stablehlo.broadcast_in_dim %164, dims = [] : (tensor<ui32>) -> tensor<4xui32>
      ...
      %173 = stablehlo.shift_left %168, %172 : tensor<4xui32>
      %174 = stablehlo.constant dense<32> : tensor<ui32>
      %175 = stablehlo.subtract %174, %170 : tensor<ui32>
      %176 = stablehlo.broadcast_in_dim %175, dims = [] : (tensor<ui32>) -> tensor<4xui32>
      ...
      %184 = stablehlo.shift_left %179, %183 : tensor<4xui32>
      %185 = stablehlo.constant dense<32> : tensor<ui32>
      %186 = stablehlo.subtract %185, %181 : tensor<ui32>
      %187 = stablehlo.broadcast_in_dim %186, dims = [] : (tensor<ui32>) -> tensor<4xui32>
      %188 = stablehlo.shift_right_logical %179, %187 : tensor<4xui32>
      %189 = stablehlo.or %184, %188 : tensor<4xui32>
      %190 = stablehlo.xor %182, %189 : tensor<4xui32>
      %191 = stablehlo.broadcast_in_dim %iterArg_3, dims = [] : (tensor<ui32>) -> tensor<4xui32>
      %192 = stablehlo.add %182, %191 : tensor<4xui32>
      %193 = stablehlo.broadcast_in_dim %iterArg_4, dims = [] : (tensor<ui32>) -> tensor<4xui32>
      %194 = stablehlo.add %190, %193 : tensor<4xui32>
      %195 = stablehlo.constant dense<1> : tensor<i32>
      %196 = stablehlo.add %iterArg_0, %195 : tensor<i32>
      %197 = stablehlo.convert %196 : (tensor<i32>) -> tensor<ui32>
      %198 = stablehlo.broadcast_in_dim %197, dims = [] : (tensor<ui32>) -> tensor<4xui32>
      %199 = stablehlo.add %194, %198 : tensor<4xui32>
      %200 = stablehlo.constant dense<1> : tensor<i32>
      %201 = stablehlo.add %iterArg, %200 : tensor<i32>
      stablehlo.return %201, %146, %192, %199, %iterArg_4, %iterArg_5, %iterArg_3, %iterArg_7, %iterArg_6 : tensor<i32>, tensor<i32>, tensor<4xui32>, tensor<4xui32>, tensor<ui32>, tensor<ui32>, tensor<ui32>, tensor<4xui32>, tensor<4xui32>
    }
    %65 = stablehlo.concatenate %64#2, %64#3, dim = 0 : (tensor<4xui32>, tensor<4xui32>) -> tensor<8xui32>
    %66 = stablehlo.broadcast_in_dim %65, dims = [1] : (tensor<8xui32>) -> tensor<1x8xui32>
    %67 = stablehlo.iota dim = 0 : tensor<4x1xui32>
    %68 = stablehlo.constant dense<8> : tensor<ui32>
    %69 = stablehlo.broadcast_in_dim %68, dims = [] : (tensor<ui32>) -> tensor<4x1xui32>
    %70 = stablehlo.multiply %69, %67 : tensor<4x1xui32>
    %71 = stablehlo.broadcast_in_dim %66, dims = [0, 1] : (tensor<1x8xui32>) -> tensor<4x8xui32>
    %72 = stablehlo.broadcast_in_dim %70, dims = [0, 1] : (tensor<4x1xui32>) -> tensor<4x8xui32>
    %73 = stablehlo.shift_right_logical %71, %72 : tensor<4x8xui32>
    %74 = stablehlo.constant dense<255> : tensor<ui32>
    %75 = stablehlo.broadcast_in_dim %74, dims = [] : (tensor<ui32>) -> tensor<4x8xui32>
    %76 = stablehlo.and %75, %73 : tensor<4x8xui32>
    %77 = stablehlo.transpose %76, dims = [1, 0] : (tensor<4x8xui32>) -> tensor<8x4xui32>
    ...
    %92 = stablehlo.broadcast_in_dim %82, dims = [] : (tensor<ui32>) -> tensor<4xui32>
    %93 = stablehlo.add %85, %92 : tensor<4xui32>
    %94 = stablehlo.broadcast_in_dim %84, dims = [] : (tensor<ui32>) -> tensor<4xui32>
    %95 = stablehlo.add %86, %94 : tensor<4xui32>
    %96 = stablehlo.constant dense<0> : tensor<i32>
    %97 = stablehlo.constant dense<0> : tensor<i32>
    %98:9 = stablehlo.while(%iterArg = %97, %iterArg_0 = %96, %iterArg_1 = %93, %iterArg_2 = %95, %iterArg_3 = %84, %iterArg_4 = %91, %iterArg_5 = %82, %iterArg_6 = %87, %iterArg_7 = %88) : tensor<i32>, tensor<i32>, tensor<4xui32>, tensor<4xui32>, tensor<ui32>, tensor<ui32>, tensor<ui32>, tensor<4xui32>, tensor<4xui32>
     cond {
      %145 = stablehlo.constant dense<5> : tensor<i32>
      %146 = stablehlo.compare  LT, %iterArg, %145,  SIGNED : (tensor<i32>, tensor<i32>) -> tensor<i1>
      stablehlo.return %146 : tensor<i1>
    ...
    %99 = stablehlo.concatenate %98#2, %98#3, dim = 0 : (tensor<4xui32>, tensor<4xui32>) -> tensor<8xui32>
    %100 = stablehlo.broadcast_in_dim %99, dims = [1] : (tensor<8xui32>) -> tensor<1x8xui32>
    %101 = stablehlo.iota dim = 0 : tensor<4x1xui32>
    %102 = stablehlo.constant dense<8> : tensor<ui32>
    %103 = stablehlo.broadcast_in_dim %102, dims = [] : (tensor<ui32>) -> tensor<4x1xui32>
    %104 = stablehlo.multiply %103, %101 : tensor<4x1xui32>
    %105 = stablehlo.broadcast_in_dim %100, dims = [0, 1] : (tensor<1x8xui32>) -> tensor<4x8xui32>
    %106 = stablehlo.broadcast_in_dim %104, dims = [0, 1] : (tensor<4x1xui32>) -> tensor<4x8xui32>
    %107 = stablehlo.shift_right_logical %105, %106 : tensor<4x8xui32>
    %108 = stablehlo.constant dense<255> : tensor<ui32>
    %109 = stablehlo.broadcast_in_dim %108, dims = [] : (tensor<ui32>) -> tensor<4x8xui32>
    %110 = stablehlo.and %109, %107 : tensor<4x8xui32>
    %111 = stablehlo.transpose %110, dims = [1, 0] : (tensor<4x8xui32>) -> tensor<8x4xui32>
    %112 = stablehlo.reshape %111 : (tensor<8x4xui32>) -> tensor<32xui32>
    %113 = stablehlo.convert %112 : (tensor<32xui32>) -> tensor<32xui8>
    %114 = stablehlo.subtract %20, %19 : tensor<1xi8>
    %115 = stablehlo.convert %114 : (tensor<1xi8>) -> tensor<1xui8>
    %116 = stablehlo.compare  LE, %20, %19,  SIGNED : (tensor<1xi8>, tensor<1xi8>) -> tensor<1xi1>
    %117 = stablehlo.constant dense<1> : tensor<ui8>
    %118 = stablehlo.broadcast_in_dim %117, dims = [] : (tensor<ui8>) -> tensor<1xui8>
    %119 = stablehlo.select %116, %118, %115 : tensor<1xi1>, tensor<1xui8>
    %120 = stablehlo.compare  GT, %20, %19,  SIGNED : (tensor<1xi8>, tensor<1xi8>) -> tensor<1xi1>
    %121 = stablehlo.broadcast_in_dim %8, dims = [] : (tensor<i1>) -> tensor<1xi1>
    %122 = stablehlo.and %121, %120 : tensor<1xi1>
    %123 = stablehlo.constant dense<1> : tensor<ui8>
    %124 = stablehlo.broadcast_in_dim %123, dims = [] : (tensor<ui8>) -> tensor<1xui8>
    %125 = stablehlo.add %119, %124 : tensor<1xui8>
    %126 = stablehlo.select %122, %125, %119 : tensor<1xi1>, tensor<1xui8>
    %127 = stablehlo.constant dense<16> : tensor<ui8>
    %128 = stablehlo.broadcast_in_dim %127, dims = [] : (tensor<ui8>) -> tensor<1xui8>
    %129 = stablehlo.remainder %128, %126 : tensor<1xui8>
    %130 = stablehlo.multiply %129, %129 : tensor<1xui8>
    %131 = stablehlo.remainder %130, %126 : tensor<1xui8>
    %132 = stablehlo.broadcast_in_dim %126, dims = [0] : (tensor<1xui8>) -> tensor<32xui8>
    %133 = stablehlo.remainder %79, %132 : tensor<32xui8>
    %134 = stablehlo.broadcast_in_dim %131, dims = [0] : (tensor<1xui8>) -> tensor<32xui8>
    %135 = stablehlo.multiply %133, %134 : tensor<32xui8>
    %136 = stablehlo.broadcast_in_dim %126, dims = [0] : (tensor<1xui8>) -> tensor<32xui8>
    %137 = stablehlo.remainder %113, %136 : tensor<32xui8>
    %138 = stablehlo.add %135, %137 : tensor<32xui8>
    %139 = stablehlo.broadcast_in_dim %126, dims = [0] : (tensor<1xui8>) -> tensor<32xui8>
    %140 = stablehlo.remainder %138, %139 : tensor<32xui8>
    %141 = stablehlo.convert %140 : (tensor<32xui8>) -> tensor<32xi8>
    %142 = stablehlo.broadcast_in_dim %19, dims = [0] : (tensor<1xi8>) -> tensor<32xi8>
    %143 = stablehlo.add %142, %141 : tensor<32xi8>
    %144 = stablehlo.custom_call @check.eq(%143, %1) : (tensor<32xi8>, tensor<32xi8>) -> tensor<i1>
  ...
  func.func private @expected() -> tensor<32xi8> {
    %0 = stablehlo.constant dense<[0, 2, -1, 4, -4, -2, 0, -1, 1, -1, 0, -4, -4, -4, -2, 1, 2, 2, -3, 0, -1, -2, -5, 1, -4, -1, 4, -3, -5, 1, -2, 0]> : tensor<32xi8>
