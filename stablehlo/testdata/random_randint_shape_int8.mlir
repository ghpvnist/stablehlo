...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %72 = stablehlo.broadcast_in_dim %71, dims = [] : (tensor<ui32>) -> tensor<4x1xui32>
    %73 = stablehlo.multiply %72, %70 : tensor<4x1xui32>
    %74 = stablehlo.broadcast_in_dim %69, dims = [0, 1] : (tensor<1x1xui32>) -> tensor<4x1xui32>
    %75 = stablehlo.shift_right_logical %74, %73 : tensor<4x1xui32>
    %76 = stablehlo.constant dense<255> : tensor<ui32>
    %77 = stablehlo.broadcast_in_dim %76, dims = [] : (tensor<ui32>) -> tensor<4x1xui32>
    %78 = stablehlo.and %77, %75 : tensor<4x1xui32>
    %79 = stablehlo.transpose %78, dims = [1, 0] : (tensor<4x1xui32>) -> tensor<1x4xui32>
    %80 = stablehlo.reshape %79 : (tensor<1x4xui32>) -> tensor<4xui32>
    %81 = stablehlo.convert %80 : (tensor<4xui32>) -> tensor<4xui8>
    %82 = stablehlo.constant dense<0> : tensor<i32>
    %83 = stablehlo.dynamic_slice %81, %82, sizes = [1] : (tensor<4xui8>, tensor<i32>) -> tensor<1xui8>
    ...
    %113 = stablehlo.broadcast_in_dim %112, dims = [] : (tensor<ui32>) -> tensor<4x1xui32>
    %114 = stablehlo.multiply %113, %111 : tensor<4x1xui32>
    %115 = stablehlo.broadcast_in_dim %110, dims = [0, 1] : (tensor<1x1xui32>) -> tensor<4x1xui32>
    %116 = stablehlo.shift_right_logical %115, %114 : tensor<4x1xui32>
    %117 = stablehlo.constant dense<255> : tensor<ui32>
    %118 = stablehlo.broadcast_in_dim %117, dims = [] : (tensor<ui32>) -> tensor<4x1xui32>
    %119 = stablehlo.and %118, %116 : tensor<4x1xui32>
    %120 = stablehlo.transpose %119, dims = [1, 0] : (tensor<4x1xui32>) -> tensor<1x4xui32>
    %121 = stablehlo.reshape %120 : (tensor<1x4xui32>) -> tensor<4xui32>
    %122 = stablehlo.convert %121 : (tensor<4xui32>) -> tensor<4xui8>
    %123 = stablehlo.constant dense<0> : tensor<i32>
    %124 = stablehlo.dynamic_slice %122, %123, sizes = [1] : (tensor<4xui8>, tensor<i32>) -> tensor<1xui8>
    %125 = stablehlo.reshape %124 : (tensor<1xui8>) -> tensor<ui8>
    %126 = stablehlo.subtract %18, %13 : tensor<i8>
    %127 = stablehlo.convert %126 : (tensor<i8>) -> tensor<ui8>
    %128 = stablehlo.compare  LE, %18, %13,  SIGNED : (tensor<i8>, tensor<i8>) -> tensor<i1>
    %129 = stablehlo.constant dense<1> : tensor<ui8>
    %130 = stablehlo.select %128, %129, %127 : tensor<i1>, tensor<ui8>
    %131 = stablehlo.compare  GT, %18, %13,  SIGNED : (tensor<i8>, tensor<i8>) -> tensor<i1>
    %132 = stablehlo.and %8, %131 : tensor<i1>
    %133 = stablehlo.constant dense<1> : tensor<ui8>
    %134 = stablehlo.add %130, %133 : tensor<ui8>
    %135 = stablehlo.select %132, %134, %130 : tensor<i1>, tensor<ui8>
    %136 = stablehlo.constant dense<16> : tensor<ui8>
    %137 = stablehlo.remainder %136, %135 : tensor<ui8>
    %138 = stablehlo.multiply %137, %137 : tensor<ui8>
    %139 = stablehlo.remainder %138, %135 : tensor<ui8>
    %140 = stablehlo.remainder %84, %135 : tensor<ui8>
    %141 = stablehlo.multiply %140, %139 : tensor<ui8>
    %142 = stablehlo.remainder %125, %135 : tensor<ui8>
    %143 = stablehlo.add %141, %142 : tensor<ui8>
    %144 = stablehlo.remainder %143, %135 : tensor<ui8>
    %145 = stablehlo.convert %144 : (tensor<ui8>) -> tensor<i8>
    %146 = stablehlo.add %13, %145 : tensor<i8>
    %147 = stablehlo.custom_call @check.eq(%146, %1) : (tensor<i8>, tensor<i8>) -> tensor<i1>
  ...
  func.func private @expected() -> tensor<i8> {
    %0 = stablehlo.constant dense<-2> : tensor<i8>
    return %0 : tensor<i8>
  }
